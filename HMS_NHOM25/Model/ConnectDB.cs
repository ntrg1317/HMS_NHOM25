...
namespace HMS_NHOM25.Model
{
    class ConnectDB
    {
        private static string connectionString = "Data Source=DESKTOP-KMNS09Q\\SQLEXPRESS;Initial Catalog=HMS_N25;Integrated Security=True;Encrypt=True;Trust Server Certificate=Truee";
